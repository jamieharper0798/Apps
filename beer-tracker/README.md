...
This app needs two free accounts (GitHub Pages, where these apps are deployed, only serves static
...
- `BEER_TRACKER_CLOUDINARY_CLOUD_NAME`
- `BEER_TRACKER_CLOUDINARY_UPLOAD_PRESET`
